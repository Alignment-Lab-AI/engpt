...
class AdamSRT(Optimizer):
    ...
    def get_dot_operator(channel_dims, shape):
        ...
        # --- ADDED: Handle scalar case explicitly ---
        if not shape: # If shape is empty tuple ()
            def scalar_multiply(tensor1, tensor2):
                return tensor1 * tensor2
            scalar_multiply.dim = 1 # Effective dimension is 1 for scalars
